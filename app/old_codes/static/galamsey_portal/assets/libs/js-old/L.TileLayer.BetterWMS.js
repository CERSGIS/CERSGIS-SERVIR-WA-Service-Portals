...
L.TileLayer.BetterWMS = L.TileLayer.WMS.extend({
    ...
    showGetFeatureInfo: function(err, latlng, content) {
      ...
      // console.log(tbl)
       labeltoshow = '<table class="table table-bordered custab" style="color:black">'
       labeltoshow += "<thead><tr style='background-color:;color:white;'><th colspan='2'> <b><center> Attribute </center></b></th></tr></thead>"
        labeltoshow += "<tbody>"
       $.each(tbl["Rows"][0], function(index2, value2) {
             labeltoshow += "<tr style='color:white;'><td><b> " + index2 +  "  </b></td><td> " + value2 +  " </td><tr>"
                
        }); 

          labeltoshow += "</tbody></table><br>"
