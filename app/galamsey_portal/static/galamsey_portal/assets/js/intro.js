...
function startIntro() {
    const introSteps = [
        ...
        },
        {
            ...
            intro: "This link would take you through a remotely sensed reference data base on which the galamsey footprints were collected. These would help you create a link between the image data and the ground reality.",
            position: 'right'
        },
        {
